...
export default class NexusWebPart extends BaseClientSideWebPart {
    constructor() {
        super(...arguments);
    ...
    _renderBox(message, detail, showUrl) {
        ...
        if (detail)
            html += '<p style="color:#999;font-size:0.85rem;margin:0.5rem 0 0;">' + detail + '</p>';
        if (showUrl)
            html += '<p style="color:#999;font-size:0.85rem;margin:0.5rem 0 0;">Document Library: <strong style="color:#2B579A;">' + showUrl + '</strong></p>';
        html += '</div>';
    ...
    render() {
        ...
        try {
            ...
            const isEditMode = this.displayMode === DisplayMode.Edit || ((_a = urlParams.get('Mode')) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === 'edit';
            if (!isConfigured && isEditMode) {
                this._renderBox('Please configure the document library for Nexus.', 'Open the web part properties and enter the library name containing the Nexus application files.', '');
                return;
            }
            if (isConfigured && isEditMode) {
                this._renderBox('Application configured and ready.', 'Save and publish this page to launch Nexus.', appBaseUrl);
                return;
            }
            if (!isConfigured && !isEditMode) {
                this._renderBox('This web part has not been configured.', 'Please contact your site administrator to set the Nexus document library.', '');
                return;
            }
...
//# sourceMappingURL=NexusWebPart.js.map